...
export const config = {
  ...
  baseUrl: `https://fcp-fdm-journey-test-suite.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `fcp-fdm-journey-test-suite-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `fcp-fdm-journey-test-suite-${process.env.ENVIRONMENT}`
        },
